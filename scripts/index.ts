...
class WorkSpace {
    ...
    private _skyboxPath: string = "https://assets.babylonjs.com/environments/environmentSpecular.env";
    ...
    */
    initCameraAndLight(nameOfCameraTarget: string, nameOfShadowsReceiver: string): void {
    ...
    */
    initPhysicsEnvironment(isVisible: boolean = false): void {
    ...
    */
    createImpostor(name: string, meshPosition: BABYLON.Vector3, parentPosition: BABYLON.Vector3, mass: number = 1, restitution: number = 0): BABYLON.Mesh {
        ...
        this._meshes.push(<BABYLON.Mesh>mesh);
...
class BoundingBox {
    ...
    constructor(x1: number, y1: number, x2: number, y2: number, width?: number, height?: number, name?: string) {
        this.x1 = x1
        this.y1 = y1
        this.x2 = x2
        this.y2 = y2
